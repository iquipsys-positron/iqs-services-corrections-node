...
export interface ICorrectionsController {
    ...
    getCorrectionById(correlationId: string, correction_id: string, callback: (err: any, correction: CorrectionV1) => void): void;
    ...
    deleteCorrectionById(correlationId: string, correction_id: string, callback: (err: any, correction: CorrectionV1) => void): void;
}
